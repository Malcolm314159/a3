...
class Form {
	...
	*/
    ...
    /**
	* Returns value if the given value is GREATER THAN (inclusive) the given parameter
	*/
    ...
    /**
	* Returns value if the given value is LESS THAN (inclusive) the given parameter
	*/
